...
object CookieStorage {
  ...
  given browserSettingsEncoder: Encoder[BrowserSettings] = deriveEncoder[BrowserSettings]
  given browserSettingsDecoder: Decoder[BrowserSettings] = deriveDecoder[BrowserSettings]
